...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/wizard/fonts/material-design-iconic-font/css/material-design-iconic-font.css')}}">

    <!-- DATE-PICKER -->
    <link rel="stylesheet" href="{{ asset('frontend/wizard/vendor/date-picker/css/datepicker.min.css')}}">
        ...
        <section>
            ...
            <table cellspacing="0" class="table-cart shop_table shop_table_responsive cart woocommerce-cart-form__contents table" id="shop_table">
                ...
                <tr>
                    <td class="product-thumb">
                        <a href="#" class="item-thumb">
                            <img src="{{ asset('frontend/wizard/images/item-1.jpg')}}" alt="">
                        </a>
                    </td>
                ...
                <tr>
                    <td class="product-thumb">
                        <a href="#" class="item-thumb">
                            <img src="{{ asset('frontend/wizard/images/item-2.jpg')}}" alt="">
                        </a>
                    </td>
                    <td class="product-detail" data-title="Product Detail">
                        <div>
...
<script src="{{asset('frontend/wizard/js/jquery-3.3.1.min.js')}}"></script>
